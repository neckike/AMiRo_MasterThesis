...
The AMiRo project was started in 2015 and ever since, the repository supporting the AMiRo project has had several updates \cite{AMiRo_Wiki}. It is worth mentioning that the version used as the basis for the present work was the version 1.0 stable. The AMiRo's repository\footnote{See: https://openresearch.cit-ec.de/projects/amiro-os/wiki} consists of three basic folders: AMiRo bootloader, AMiRo Operating System, and ChibiOS.
