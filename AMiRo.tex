...
\chapter{Results}
In this chapter the structure and functionality of both projects DA\_AMiRo and DAEbot are compared. As it was intended, this project will ultimately help to improve the behavior, structure, and functionality of the DAEbot. Through a thorough analysis, some recommendations for the DAEbot project are made for future work.
