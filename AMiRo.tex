...
\subsection{Sensors}
In order to interact with a sensor, the id from the CAN frame's command to be sent has to obey the convention shown in figure \ref{fig:can} and its content, the data from the CAN frame has to follow the convention shown in figure  \ref{fig:sensormodes} created by Uwe Jahn for the DAEbot project.

%explicar la figura de los modos para recibir valores de sensores.
