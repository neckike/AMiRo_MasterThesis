...
% Hablar mucho del AMIRO OS --...mucho
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=\textwidth, height=15cm]{standalone_first}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=\textwidth, height=18cm]{standalone_last}
  	\caption{Demo Standalone results part 2}
  	\label{fig:res2}
\end{figure}

In figures \ref{fig:res1} the values of the accelerometer are visualized and also the values from the proximity ring sensors. In figure \ref{fig:res2} values of power status, magnetometer, and proximity floor sensors can be seen.
